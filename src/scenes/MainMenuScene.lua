...
function MainMenuScene:new()
    local this = {
        ...
        logo = love.graphics.newImage("assets/game_name.png"),
    ...
    scaleDimension:calculeScales("menuLogo", 500, 159, 0, 50)
    ...
    addButton(this, 'Start Game', "intro", {128, 60, 350, 320}, originalSize)
    addButton(this, 'Credits', "credits", {128, 60, 350, 390}, originalSize)
